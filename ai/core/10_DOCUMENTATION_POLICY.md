...
- The preferred language must be verified or requested rather than permanently assumed. This is a configurable project-policy concept; no configuration file is defined by this policy yet.
