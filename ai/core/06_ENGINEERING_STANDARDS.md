...
- All communication intended for the current project owner or lead developer uses that person's validated project-configured preferred language, including progress, explanations, recommendations, summaries, warnings, and completion messages.
...
`16_GIT_POLICY.md` is the canonical repository-safety source. Other engineering
documents reference it instead of redefining staging, commit, push, branch, tag,
untracked-file, and destructive-recovery rules.

The Reusable Engineering Framework version and validated project configuration
define project identity and project-specific validation commands. Mandatory
safety behavior remains universal and non-configurable.
