...
var english = map[MessageID]string{
	...
	"summary.version": "Installed QWSG version: %s", "summary.guardian": "Guardian: %s", "summary.active": "activation requested", "summary.inactive": "not activated", "summary.notification": "Notification: optional; configurable later", "summary.policy": "Update policy: %s (automatic privileged updates disabled)",
	...
	"notification.prompt":  "Configure email notification now? [y/N]",
...
var hungarian = map[MessageID]string{
	...
	"readiness.ready": "Üzemkészség: kész. A Guardian előállította a szükséges működési bizonyítékot.", "readiness.partial": "Üzemkészség: hiányos. A telepítési adatok megmaradtak; kövesse a `qwsg readiness` útmutatását, majd folytassa a beállítást.", "summary.version": "Telepített QWSG-verzió: %s", "summary.guardian": "Guardian: %s", "summary.active": "aktiválás kérve", "summary.inactive": "nincs aktiválva", "summary.notification": "Értesítés: opcionális; később beállítható", "summary.policy": "Frissítési szabály: %s (az automatikus jogosultságemelt frissítés kikapcsolva)",
...
var german = map[MessageID]string{
	...
	"readiness.ready": "Bereitschaft: bereit. Guardian hat den erforderlichen Betriebsnachweis erzeugt.", "readiness.partial": "Bereitschaft: unvollständig. Installationsdaten bleiben erhalten; folgen Sie `qwsg readiness` und setzen Sie danach die Einrichtung fort.", "summary.version": "Installierte QWSG-Version: %s", "summary.guardian": "Guardian: %s", "summary.active": "Aktivierung angefordert", "summary.inactive": "nicht aktiviert", "summary.notification": "Benachrichtigung: optional; später konfigurierbar", "summary.policy": "Aktualisierungsrichtlinie: %s (automatische privilegierte Aktualisierungen deaktiviert)",
